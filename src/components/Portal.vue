  ...
  <el-container>
      ...
      <el-card>
        ...
        >
          <el-option
            ...
            :value="category.rank_category_id"
          ></el-option>
        </el-select>
        <el-button
      ...
      <div>
        ...
        >
          <div slot="header">
            ...
            <el-button
              type="text"
              @click.stop="jump_to_simulation(simulation)"
          ...
          <el-button
            type="text"
            @click.stop="jump_to_user_page(simulation)"
    ...
    <el-aside>
      ...
      <el-card style="margin-top: 50px" v-else>
        <div style="text-align: center; font-size: large">登录查看我的模拟</div>
      </el-card>
    </el-aside>
  </el-container>
</template>
...
export default {
  ...
  mounted() {
    this.$api.post("/physlet_api/getSims").then((response) => {
