<template>
  <el-container>
    ...
    <el-main>
      ...
      <div v-if="!loading_simulations">
        ...
        >
          <div slot="header">
            ...
            <h3
              style="margin-right: 3px; width: 80%"
      ...
      <div v-if="!loading_users">
        <el-card>
          v-for="user in search_user_list" :key="user.user_id"
          @click="jump_to_user_page(user)" style="cursor: pointer" >
          <div slot="header">
          ...
          <div>
            ...
            <span style="float: right"
              ><i class="fa-regular fa-thumbs-up"></i> {{ user.likes }}</span
            >
          </div>
        </el-card>
      </div>
