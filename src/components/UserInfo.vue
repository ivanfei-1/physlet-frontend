  ...
  <el-container>
    ...
    <el-main>
      ...
      >
        ...
        <el-form-item>
          <el-button type="primary" @click="submit_userinfo('edit_userinfo')"
            >修改</el-button
          >
        </el-form-item>
      </el-form>
      ...
      <el-button size="small" type="success" @click="submit_avatar"
        >点击上传头像</el-button
      >
    </el-main>
    <el-aside>
      <el-card>
        <div style="text-align: center">
          ...
          <div style="text-align: center; font-size: 20px; margin-top: 20px">
            欢迎, {{ this.display_username }}
          </div>
        </div>
        <div style="text-align: center" v-if="!loading_avatar"></div>
      </el-card>
    </el-aside>
  </el-container>
</template>
...
export default {
  ...
  methods: {
    ...
    submit_avatar() {
      ...
      this.$api
        .post("/physlet_api/uploadAvatar", formData, { headers })
        .then((res) => {
