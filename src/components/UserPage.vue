<template>
  <el-container>
    ...
    <el-main>
      ...
      <el-pagination>
        style="display:table; margin:0 auto; " @current-change="current_change"
        :current-page="current_page" layout="prev, pager, next"
        :hide-on-single-page="true" :pager-count="11" :page-size="10"
